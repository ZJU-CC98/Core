...
public static class IdentityHelper
{
	...
	public static Claim CreateIdentityProviderClaim(string identityProviderValue)
	{
		...
		return new(IdentityProviderClaimType, identityProviderValue, ClaimValueTypes.String);
	}
	...
	public static void AddIdentityProvider(this ClaimsIdentity identity, string value)
	{
		...
		identity.AddClaim(new(IdentityProviderClaimType, value, ClaimValueTypes.String));
	}
	...
	public static ClaimsIdentity CloneAs(this ClaimsIdentity identity, string authenticationType)
	{
		...
		return new(identity.Claims, authenticationType, identity.NameClaimType,
	...
	/// <returns>如果 <paramref name="principal" /> 属于 <paramref name="roles" /> 中所定义的任意一个用户组，则返回 <c>true</c>；否则返回 <c>false</c>。</returns>
