...
namespace CC98.Authentication
{
    ...
    public static class CC98AuthenticationExtensions
    {
        ...
        {
            return builder.AddCC98(CC98AuthenticationDefaults.AuthenticationScheme, _ => { });
        }
        ...
        /// <returns><paramref name="builder" /> 参数。</returns>
        public static AuthenticationBuilder AddCC98(this AuthenticationBuilder builder,
            Action<CC98AuthenticationOptions> configureOptions)
        {
            return builder.AddCC98(CC98AuthenticationDefaults.AuthenticationScheme, configureOptions);
        }
        ...
        public static AuthenticationBuilder AddCC98(this AuthenticationBuilder builder, string authenticationScheme,
            Action<CC98AuthenticationOptions> configureOptions)
        {
            return builder.AddCC98(authenticationScheme, CC98AuthenticationDefaults.DisplayName, configureOptions);
        }
        ...
        /// <returns><paramref name="builder" /> 参数。</returns>
        public static AuthenticationBuilder AddCC98(this AuthenticationBuilder builder, string authenticationScheme,
            string displayName, Action<CC98AuthenticationOptions> configureOptions)
        {
            return builder.AddOAuth<CC98AuthenticationOptions, CC98AuthenticationHandler>(authenticationScheme,
