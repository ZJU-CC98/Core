...
namespace CC98.Authentication
{
    ...
    {
        /// <summary>
        /// 为 <see cref="ClaimActionCollection"/> 添加一个 <see cref="ArrayJsonKeyClaimAction"/> 对象。新声明的值类型被定义为 <see cref="ClaimValueTypes.String"/>。
        /// </summary>
        ...
        public static void MapArrayJsonKey(this ClaimActionCollection claimActions, string claimType, string jsonKey, string valueType)
        {
